...
-- Tabela ATRIBUTO (Atributos Gerais)
...
-- Tabela ATRIBUTOS_BASE (Atributos específicos para Raças)
...
-- Tabela MEMBROS_PARTY (Relação muitos-para-muitos entre personagens e party)
